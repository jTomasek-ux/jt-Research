...
Jednotlivá evropská firma může být skvělá. To ale nestačí k odpovědi na otázku, zda Evropa dokáže mít suverenitu v AI: vlastní kapacitu trénovat, nasazovat a udržovat frontier systémy bez strategické závislosti. Tento text proto sleduje EU jako pole hry, ne jako katalog firemních PR zpráv.

Grafy níže jsou **ilustrativní syntézy pro argumentaci**. Mají udělat tezi čitelnou. Nejsou náhradou za živý leaderboard ani za jeden PitchBook export. Až budete chtít tvrdší čísla, grafy se vymění.
...
### Proč nestačí „jen VLM a vertical“

Krátká odpověď: **pro firmy často ano. Pro stát a suverenitu ne.**

VLM a vertical AI jsou v pohodě, pokud cílem je produktivita: lepší OCR, lepší dokumenty, lepší copilot ve firmě, lepší produkt na cizím base modelu. Evropa v tom může být výborná a vydělat peníze. Nemusíš vlastnit frontier, abys prodával workflow na Claudovi, GPT nebo Kimi.

Tohle ale padá ve chvíli, kdy se AI čte jako infrastruktura moci, ne jako SaaS feature:

1. **Závislost na přístupu.** Vertical a VLM bez vlastního frontieru jsou wrappery. Když US lab nebo politika omezí, komu smí Evropa nejlepší modely používat, evropský produkt najednou stojí na cizím povolení. Nemáš náhradní váhy stejné třídy.
2. **Cenu a podmínky nastavuje někdo jiný.** Kdo vlastní frontier, nastavuje API pricing, rate limity, regionální dostupnost a compliance podmínky. Evropa pak negociuje z pozice kupce, ne producenta.
3. **Talent a data tečou nahoru.** Nejlepší výzkumníci a nejsilnější tréninkové signály jdou tam, kde se trénuje frontier. Vertical scéna to částečně kompenzuje aplikovanou prací, ale neudrží lab, který umí další skok v reasoning / agentic schopnostech.
4. **Státní poptávka bez domácí nabídky.** Armáda, justice, zdravotnictví a kritická infrastruktura nechtějí dlouhodobě jet jen na cizím closed modelu. Bez domácího nebo suverénně hostitelného frontieru zůstane „AI ve státě“ buď slabá, nebo geopoliticky riziková.
5. **Open-weight tlak to nevyřeší samo.** Čínské open váhy můžou Evropě krátkodobě pomoct jako levná náhrada. To ale není evropská suverenita. Je to výměna jedné závislosti za druhou, plus otázka trustu a supply chainu.

Takže: **Evropa nutně nepotřebuje frontier model, aby měla úspěšné AI firmy.** Potřebuje frontier (nebo aspoň blízko-frontier + vlastní compute), pokud chce mít AI suverenitu: schopnost trénovat, provozovat a nahradit inteligenci, když se zahraniční kohoutek přivře. VLM-only strategie je racionální business sázka a strategicky křehká státní sázka.
